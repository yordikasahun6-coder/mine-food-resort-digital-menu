      ...
      <div className="bg-gradient-to-r from-[#0A0A0A] to-[#1A1A1A] border-b border-[#B3945B]/20 px-6 py-5">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-[#B3945B]">Edit Menu Item</h1>
              <p className="text-gray-500 text-sm">Modify dish details</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <div className="bg-[#1A1A1A] rounded-2xl border border-[#B3945B]/20 p-5 hover:border-[#B3945B]/40 transition">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full p-3 pl-16 rounded-xl bg-[#0A0A0A] border border-gray-700 text-white focus:border-[#B3945B] transition"
                    required
                  />
                </div>
              </div>
