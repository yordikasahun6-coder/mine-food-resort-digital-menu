      ...
      <div className="min-h-screen bg-gradient-to-br from-[var(--bg-primary)] to-[var(--bg-secondary)] p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-[var(--bg-card)] rounded-xl p-6 border border-[var(--border-color)]">
            ...
            <p className="text-3xl font-bold text-[var(--gold)]">{new Set(items.map(i => i.item_type)).size}</p>
          </div>
        </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-[var(--border-color)]">
                  ...
                  <th className="px-6 py-4 text-left text-[var(--gold)] text-sm">Type</th>
                  <th className="px-6 py-4 text-left text-[var(--gold)] text-sm">Price (BIRR)</th>
              ...
              <tbody>
                {items.map((item) => (
                  <tr key={item.id} className="border-b border-[var(--border-color)] hover:bg-[var(--gold)]/5">
                    ...
                    <td className="px-6 py-4 text-[var(--text-secondary)] capitalize">{item.item_type}</td>
